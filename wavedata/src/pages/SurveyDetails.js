...
function SurveyDetails() {
	...
	async function AddCategory(e, index) {
		...
		await window.sendTransaction(contract.CreateSurveyCategory(categoryname.value, categoryimagelink.value));
	...
	async function SaveSection(e) {
		...
		try {
			await window.sendTransaction(contract.CreateOrSaveSections(SURVEY_DATA.id, JSON.stringify(sectionsdata)));
		} catch (error) {
